//! The ext2 Schema.
//!
//! From `dylanmc/cs393_ext2` on github.
...
/// The ext2 superblock start address.
pub const EXT2_START_OF_SUPERBLOCK: usize = 1024;

/// The ext2 superblock end address.
pub const EXT2_END_OF_SUPERBLOCK: usize = 2048;
